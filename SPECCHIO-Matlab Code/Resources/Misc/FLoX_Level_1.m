...
function FLOXBOX_Level_1(hierarchy_id, specchio_pathname, db_connector_id)


hierarchy_id = hierarchy_id; %747 [826]
% specchio_pathname = '/Applications/SPECCHIO_G4/SPECCHIO.app/Contents/Java/';
%         mainAppDir = uigetdir;
%         javaaddpath([ mainAppDir '\specchio-client.jar'], [mainAppDir '\); % DOES NOT WORK IN RUN-TIME!
